...
public class MovieTabFragment extends Fragment implements CineListener.OnMovieClickListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    public static MovieTabFragment newInstance(String movieCategory) {
