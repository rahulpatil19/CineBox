...
public class PopularTvFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener, CineListener.OnTvClickListener {
    ...
    private final String REQUEST_TAG = "popular";
    ...
    private void fetchTvShows() {
        if (isEndOfPage && currentPage <= totalPages) {
            ...
            String tvListUrl = CineUrl.createTvListUrl("popular", currentPage);
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_tv_popular, container, false);
    }
