...
public class PopularMovieFragment extends Fragment implements CineListener.OnMovieClickListener,
    ...
    private static final String REQUEST_TAG = "popular";
    ...
    private String buildMovieUrl(int page) {
        return CineUrl.createMovieListUrl(CineUrl.CATEGORY_POPULAR, page);
    }
